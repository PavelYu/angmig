...
## Overview
This document details how AI agents (Zed + MCP) accelerate the Angular v14 → v20 migration through intelligent automation, pattern learning, and team augmentation.
